...
export default function WhatsAppButton({ message, disabled = false }) {
  const handleClick = () => {
    ...
    // Відкриваємо WhatsApp без вказання номера - користувач сам вибере контакт
    const url = getWhatsAppUrl(null, message);
  ...
  return (
    <button
      ...
      title="Wyślij raport do WhatsApp"
    >
      <svg
        className={s.icon}
        viewBox="0 0 24 24"
